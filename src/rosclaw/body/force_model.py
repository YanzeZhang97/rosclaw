...
class ForceModel:
    ...
    def __init__(
        self,
        baseline: dict[str, ForceBaseline] | None = None,
        thresholds: dict[str, float] | None = None,
        contact_windows: dict[str, DofForceWindow] | None = None,
    ...
    def contact_level(self, net_force: float | None, dof: str) -> str | None:
    ...
    def is_desired_contact(self, net_force: float | None, dof: str) -> bool:
        if net_force is None:
            return False
        w = self.window(dof)
    ...
    def is_over_contact(self, net_force: float | None, dof: str) -> bool:
        if net_force is None:
            return False
