...
EMBODIMENT = RobotEmbodimentProfile(
    ...
    joints=[
        ...
        {
            "name": "camera_depth_optical_joint",
            "type": "fixed",
            "parent": "camera_depth_frame",
            "child": "camera_depth_optical_frame",
        },
        {
            "name": "camera_infra1_joint",
            "type": "fixed",
            "parent": "camera_link",
            "child": "camera_infra1_frame",
        },
        {
            "name": "camera_infra1_optical_joint",
            "type": "fixed",
            "parent": "camera_infra1_frame",
            "child": "camera_infra1_optical_frame",
        },
        {
            "name": "camera_infra2_joint",
            "type": "fixed",
            "parent": "camera_link",
            "child": "camera_infra2_frame",
        },
        {
            "name": "camera_infra2_optical_joint",
            "type": "fixed",
            "parent": "camera_infra2_frame",
            "child": "camera_infra2_optical_frame",
        },
        {
        ...
        {
            "name": "camera_accel_joint",
            "type": "fixed",
            "parent": "camera_link",
            "child": "camera_accel_frame",
        },
        {
            "name": "camera_accel_optical_joint",
            "type": "fixed",
            "parent": "camera_accel_frame",
            "child": "camera_accel_optical_frame",
        },
        {
            "name": "camera_gyro_joint",
            "type": "fixed",
            "parent": "camera_link",
            "child": "camera_gyro_frame",
        },
        {
            "name": "camera_gyro_optical_joint",
            "type": "fixed",
            "parent": "camera_gyro_frame",
            "child": "camera_gyro_optical_frame",
        },
    ],
    sensors=[
        {
            "name": "color_camera",
            "type": "camera",
            "parent_link": "camera_color_optical_frame",
            "resolution": [1280, 720],
            "fov": 90.0,
            "fps": 30,
        },
        {
            "name": "depth_camera",
            "type": "depth_camera",
            "parent_link": "camera_depth_optical_frame",
            "resolution": [1280, 720],
            "fov": 90.0,
            "fps": 30,
            "min_range": 0.1,
        ...
        },
        {
            "name": "infrared_left",
            "type": "camera",
            "parent_link": "camera_infra1_optical_frame",
            "resolution": [1280, 720],
            "fov": 90.0,
            "fps": 30,
        },
        {
            "name": "infrared_right",
            "type": "camera",
            "parent_link": "camera_infra2_optical_frame",
            "resolution": [1280, 720],
            "fov": 90.0,
            "fps": 30,
        },
...
CAPABILITY = RobotCapabilityProfile(
    ...
    precondition_checks={
        "camera_info_available": {
            "check": "camera_info topic publishing",
            "description": "Camera intrinsics must be available",
        },
        "tf_available": {
            "check": "camera frame in tf tree",
            "description": "Camera extrinsics must be resolved",
        },
    },
)
...
SEMANTIC = RobotSemanticProfile(
    ...
    functional_regions=[
        {
            "name": "mount",
            "link": "realsense_d435i_mount",
            "tags": ["mount", "base", "attachment"],
            "description": "Mechanical mount to robot body",
            "affordances": ["attach"],
        },
        {
            "name": "camera_body",
            "link": "camera_link",
            "tags": ["camera_body", "sensor_housing"],
            "description": "Main camera housing with integrated IMU",
        },
        {
            "name": "color_optical",
            "link": "camera_color_optical_frame",
            "tags": ["color_sensor", "optical_frame"],
            "description": "Color image optical center",
        },
        {
            "name": "depth_optical",
            "link": "camera_depth_optical_frame",
            "tags": ["depth_sensor", "optical_frame"],
            "description": "Depth image optical center",
        },
        {
            "name": "imu",
            "link": "camera_accel_frame",
            "tags": ["imu", "accelerometer", "gyroscope"],
            "description": "Integrated IMU frame",
        },
    ],
    grasp_points=[],
    visual_features=[
        {
            "name": "camera_housing",
            "type": "rectangular_sensor",
            "links": ["camera_link"],
            "visual_cues": ["black_rectangular_housing"],
            "llm_description": "Small rectangular RGB-D camera housing with IMU",
        },
        {
            "name": "lens_assembly",
            "type": "lens_cluster",
            "links": ["camera_color_frame", "camera_depth_frame"],
            "visual_cues": ["lenses", "infrared_projector"],
            "llm_description": "Cluster of color/depth lenses on the camera face",
        },
    ],
    task_descriptions={
        "rgb_observation": {
            "relevant_links": ["camera_color_optical_frame"],
            "description": "Capture color images",
        },
        "depth_observation": {
            "relevant_links": ["camera_depth_optical_frame"],
            "description": "Capture depth images",
            "safety": "Requires calibration for metric use",
        },
        "imu_observation": {
            "relevant_links": ["camera_accel_frame", "camera_gyro_frame"],
            "description": "Capture accelerometer/gyro data",
        },
    },
    semantic_tags=[
        "rgbd_camera",
