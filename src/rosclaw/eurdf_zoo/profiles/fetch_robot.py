...
SAFETY = RobotSafetyProfile(
    ...
    joint_soft_limits={
        "torso_lift_joint": {"lower": 0.02, "upper": 0.366, "k_position": 100.0, "k_velocity": 50.0}
    },
    pfl={"enabled": True, "max_tcp_force": 80.0, "max_tcp_torque": 4.0, "max_static_force": 30.0},
    collision_detection={
        "method": "force_threshold",
        "threshold_force": 30.0,
        "threshold_torque": 2.0,
...
CAPABILITY = RobotCapabilityProfile(
    ...
    precondition_checks={
        "gripper_attached": {
            "check": "gripper_link.child_links > 0",
            "description": "Gripper must be attached",
        },
        "object_in_reach": {"check": "distance <= 1.2", "description": "Object within reach"},
        "object_mass_leq_2kg": {
            "check": "object.mass <= 2.0",
            "description": "Object must not exceed 2kg",
        },
    },
)
    ...
    functional_regions=[
        {
            "name": "mobile_base",
            "link": "base_link",
            "tags": ["mobile", "differential_drive", "foundation"],
            "description": "Differential drive mobile base",
            "affordances": ["move", "rotate", "navigate"],
        },
        {
            "name": "torso",
            "link": "torso_lift_link",
            "tags": ["lift", "adjustable_height"],
            "description": "Telescoping torso lift",
            "affordances": ["raise", "lower"],
        },
        {
            "name": "gripper",
            "link": "gripper_link",
            "tags": ["end_effector", "gripper", "manipulation"],
            "description": "Parallel jaw gripper",
            "affordances": ["grasp", "release"],
        },
        {
            "name": "head",
            "links": ["head_pan_link", "head_tilt_link"],
            "tags": ["head", "pan_tilt", "perception"],
            "description": "Pan-tilt head with RGB-D camera",
            "affordances": ["look", "scan"],
        },
    ],
    grasp_points=[],
    visual_features=[
        {
            "name": "mobile_base_visible",
            "type": "cylindrical_base",
            "links": ["base_link"],
            "visual_cues": ["white_cylinder", "wheels"],
            "llm_description": "White cylindrical mobile base with two drive wheels",
        },
        {
            "name": "arm_visible",
            ...
            "visual_cues": ["white_tubes", "joints"],
            "llm_description": "White articulated arm with multiple joints",
        },
        {
            "name": "head_visible",
            "type": "pan_tilt_head",
            "links": ["head_pan_link", "head_tilt_link", "head_camera_link"],
            "visual_cues": ["white_head", "camera_lens"],
            "llm_description": "Pan-tilt head with camera mounted on front",
        },
    ],
    task_descriptions={
        "pick_and_place": {
            "relevant_links": ["wrist_flex_link", "wrist_roll_link", "gripper_link"],
            "workspace_hint": "Objects within 1.2m of robot base",
            "collision_warning": "Watch base laser scanner when moving",
        },
        "navigate": {
            "relevant_links": ["base_link"],
            "description": "Robot drives to target location",
            "sensors": ["base_laser"],
        },
    },
    semantic_tags=[
...
BENCHMARK = RobotBenchmarkProfile(
    ...
    kinematic_benchmarks=[
        {
            "name": "ik_solve_rate",
            "description": "IK success rate for 7-DOF arm",
            "target": 0.99,
            "timeout_ms": 10.0,
        },
    ...
    dynamic_benchmarks=[
        {
            "name": "trajectory_tracking_error",
            "description": "RMSE of arm joint tracking",
            "target": 0.002,
            "unit": "rad",
        },
        {
            "name": "base_odometry_drift",
            "description": "Position drift over 100m",
            "target": 0.5,
            "unit": "m",
        },
    ],
    ...
    task_benchmarks=[
        {
            "name": "office_navigation_10",
            "description": "Navigate to 10 waypoints",
            "tasks": ["navigate"],
            "metrics": [
                {"name": "success_rate", "target": 0.90},
                {"name": "collision_count", "target": 0},
            ],
        },
        {
            "name": "tabletop_pick_5",
            "description": "Pick 5 objects",
            "tasks": ["pick_and_place"],
            "metrics": [{"name": "success_rate", "target": 0.90}],
        },
    ],
    safety_benchmarks=[
        {
            "name": "emergency_stop_latency",
            "description": "Time from trigger to full stop",
            "target": 300.0,
            "unit": "ms",
        },
        {
            "name": "collision_force_at_stop",
            "description": "Contact force when stop triggers",
            "target": 80.0,
            "unit": "N",
        },
    ],
