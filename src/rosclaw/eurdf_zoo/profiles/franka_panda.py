...
SAFETY = RobotSafetyProfile(
    ...
    collision_detection={
        ...
        "threshold_force": 40.0,
        "threshold_torque": 2.5,
        "reaction_time_ms": 2.0,
    },
    emergency_stop={
        "category": 3,
        "stop_time_ms": 200.0,
    ...
    interaction={
        "hand_guiding": True,
        "speed_slider_max": 0.25,
        "force_guiding_max": 10.0,
        "protective_stop_on_contact": True,
    },
    environment={
        "ambient_temp_min": 0.0,
    ...
    capabilities=[
        {
            ...
            "constraints": {"max_payload": 3.0, "max_reach": 0.855},
        },
        {
            "id": "panda_insertion",
            "name": "insertion",
    ...
    functional_regions=[
        {
            "name": "base",
            "link": "base_link",
            "tags": ["mount", "stationary"],
            "description": "Fixed base mounting point",
            "affordances": [],
        },
        {
            "name": "wrist_assembly",
            "links": ["link5", "link6", "link7"],
            "tags": ["wrist", "compact", "dexterous", "3dof"],
            "description": "Three intersecting wrist joints",
            "affordances": ["orient", "rotate"],
        },
        {
            "name": "tool_mount",
            "link": "flange",
            "tags": ["end_effector_mount", "tcp"],
            "description": "Tool mounting flange",
            "affordances": ["attach_tool", "attach_gripper"],
        },
    ],
    grasp_points=[
        {
            "name": "upper_arm_grasp",
            "link": "link2",
            "position": [0, 0, 0.15],
            "approach_direction": [0, 0, 1],
            "description": "For hand-guiding",
            "safety": {"max_force": 50.0},
        },
    ],
    visual_features=[
        {
            "name": "shoulder_joint_visible",
            "type": "rotary_joint",
            "links": ["base_link", "link1"],
            "visual_cues": ["white_ring"],
            "llm_description": "Circular joint where robot connects to base",
        },
    ],
    task_descriptions={
        "pick_and_place": {
            "relevant_links": ["link6", "link7", "flange"],
            "workspace_hint": "Objects within 855mm of base",
            "collision_warning": "Watch elbow when reaching low objects",
        },
    },
    semantic_tags=[
        "collaborative_robot",
...
BENCHMARK = RobotBenchmarkProfile(
    ...
    kinematic_benchmarks=[
        {
            "name": "ik_solve_rate",
            "description": "Success rate of analytical IK",
            "target": 0.999,
            "timeout_ms": 5.0,
        },
    ...
    dynamic_benchmarks=[
        {
            ...
            "description": "RMSE of joint tracking",
            "target": 0.001,
            "unit": "rad",
        },
        {
            "name": "force_control_bandwidth",
            "description": "Force control bandwidth",
            "target": 1000.0,
            "unit": "Hz",
        },
    ],
    ...
    task_benchmarks=[
        {
            "name": "tabletop_pick_10",
            "description": "Pick 10 objects",
            "tasks": ["pick_and_place"],
            "metrics": [{"name": "success_rate", "target": 0.95}],
        },
    ],
    safety_benchmarks=[
        {
            "name": "pfl_response_time",
            "description": "PFL response time",
            "target": 2.0,
            "unit": "ms",
        },
    ],
