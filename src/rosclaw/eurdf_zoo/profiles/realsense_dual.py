...
EMBODIMENT = RobotEmbodimentProfile(
    ...
    joints=[
        {"name": "head_mount_joint", "type": "fixed", "parent": "base_link", "child": "head_mount"},
        {
            ...
            "type": "fixed",
            "parent": "head_mount",
            "child": "head_realsense_d405_mount",
        },
        {
            "name": "head_camera_optical_joint",
            "type": "fixed",
            "parent": "head_realsense_d405_mount",
            "child": "head_camera_link",
        },
        {
            "name": "head_depth_optical_joint",
            "type": "fixed",
            "parent": "head_camera_link",
            "child": "head_camera_depth_optical_frame",
        },
        {
            "name": "head_color_optical_joint",
            "type": "fixed",
            "parent": "head_camera_link",
            "child": "head_camera_color_optical_frame",
        },
        {
            "name": "wrist_mount_joint",
            "type": "fixed",
            "parent": "base_link",
            "child": "wrist_mount",
        },
        {
            ...
            "type": "fixed",
            "parent": "wrist_mount",
            "child": "wrist_realsense_d435i_mount",
        },
        {
            "name": "wrist_camera_optical_joint",
            "type": "fixed",
            "parent": "wrist_realsense_d435i_mount",
            "child": "wrist_camera_link",
        },
        {
            "name": "wrist_depth_optical_joint",
            "type": "fixed",
            "parent": "wrist_camera_link",
            "child": "wrist_camera_depth_optical_frame",
        },
        {
            "name": "wrist_color_optical_joint",
            "type": "fixed",
            "parent": "wrist_camera_link",
            "child": "wrist_camera_color_optical_frame",
        },
        {
            "name": "wrist_accel_joint",
            "type": "fixed",
            "parent": "wrist_camera_link",
            "child": "wrist_camera_accel_frame",
        },
        {
            "name": "wrist_gyro_joint",
            "type": "fixed",
            "parent": "wrist_camera_link",
            "child": "wrist_camera_gyro_frame",
        },
    ],
    sensors=[
        {
            "name": "head_color_camera",
            "type": "camera",
        ...
        },
        {
            ...
            "type": "depth_camera",
            "parent_link": "head_camera_depth_optical_frame",
            "resolution": [1280, 720],
            "fov": 90.0,
            "fps": 30,
            "min_range": 0.05,
        ...
        {
            "name": "wrist_color_camera",
            "type": "camera",
            "parent_link": "wrist_camera_color_optical_frame",
            "resolution": [1280, 720],
            "fov": 90.0,
            "fps": 30,
        },
        {
            "name": "wrist_depth_camera",
            "type": "depth_camera",
            "parent_link": "wrist_camera_depth_optical_frame",
            "resolution": [1280, 720],
            "fov": 90.0,
            "fps": 30,
            "min_range": 0.1,
...
CAPABILITY = RobotCapabilityProfile(
    ...
    precondition_checks={
        "camera_info_available": {
            "check": "camera_info topics publishing",
            "description": "Camera intrinsics must be available",
        },
        "tf_available": {
            "check": "camera frames in tf tree",
    ...
    functional_regions=[
        {
            ...
            "description": "Common reference frame",
            "affordances": ["attach"],
        },
        {
            "name": "head_camera",
            "link": "head_camera_link",
            "tags": ["head", "rgbd_camera"],
            "description": "Head-mounted short-range RGB-D camera",
        },
        {
            "name": "wrist_camera",
            "link": "wrist_camera_link",
            "tags": ["wrist", "rgbd_camera", "imu"],
            "description": "Wrist-mounted RGB-D camera with IMU",
        },
    ],
    grasp_points=[],
    visual_features=[
        {
            ...
            "llm_description": "Head-mounted RealSense D405",
        },
        {
            "name": "wrist_sensor",
            "type": "rectangular_sensor",
            "links": ["wrist_camera_link"],
            "visual_cues": ["black_rectangular_housing"],
            "llm_description": "Wrist-mounted RealSense D435i with IMU",
        },
    ],
    task_descriptions={
        "head_rgb_observation": {
            "relevant_links": ["head_camera_color_optical_frame"],
            "description": "Capture head color images",
        },
        "wrist_depth_observation": {
            "relevant_links": ["wrist_camera_depth_optical_frame"],
            "description": "Capture wrist depth images",
            "safety": "Requires hand-eye calibration",
        },
    },
    semantic_tags=[
        "rgbd_camera",
